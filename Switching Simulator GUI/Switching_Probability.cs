...
{
    public partial class Switching_Probability : Form
    {
        public Switching_Probability()
        {
            InitializeComponent();
        ...
        private void btn_convert_Click(object sender, EventArgs e)
        {
            ...
            if (cbMunits.SelectedIndex != -1 && cbHunits.SelectedIndex != -1)
            {
                ...
                mp.I_to_j_dc(double.Parse(tbIdc.Text));
                mp.I_to_j_ac(double.Parse(tbIac.Text));
                if (cbShotNoise.Checked == true)
                {
                    mp.I_to_d_sh(double.Parse(tbIdc.Text));
                }
